...
import { Bell, Send, Trash2, X, AlertCircle, CheckCircle2, User, Users, Megaphone, Link as LinkIcon } from 'lucide-react';
          ...
          <form onSubmit={handleSend} className="space-y-3.5 text-xs">
            ...
            {target === 'specific_user' && (
              <div className="space-y-1 animate-fade-in">
                <label className="font-semibold text-slate-300">Select Player</label>
                <select
                  value={targetUid}
