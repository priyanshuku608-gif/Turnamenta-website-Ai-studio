      ...
      <div className="relative w-full max-w-md bg-[#1E293B] border border-slate-700 rounded-t-3xl sm:rounded-2xl p-5 shadow-2xl flex flex-col text-slate-100 overflow-hidden max-h-[90vh]">
        ...
        <div className="flex items-center justify-between pb-3 border-b border-slate-700/80">
          <div className="flex items-center gap-2">
            ...
            <h2 className="font-bold text-base text-white">Withdraw Winnings</h2>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="bg-[#0F172A] p-4 rounded-xl border border-slate-800 my-3 text-center">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 overflow-y-auto flex-1 pr-1">
          ...
          <div>
            ...
            <input
              ...
              max={winningCash}
              required
              className="w-full bg-[#0F172A] border border-slate-700 focus:border-[#B6FF3C] rounded-xl px-3.5 py-3 text-sm font-bold text-white placeholder-slate-500 outline-none transition"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              required
              className="w-full bg-[#0F172A] border border-slate-700 focus:border-[#B6FF3C] rounded-xl px-3.5 py-3 text-sm text-white placeholder-slate-500 outline-none transition"
            />
          </div>
          ...
          <button
            ...
            className="w-full py-3.5 bg-blue-600 hover:bg-blue-500 text-white font-bold text-sm rounded-xl flex items-center justify-center gap-2 transition active:scale-98 disabled:opacity-50 shadow-lg"
          >
