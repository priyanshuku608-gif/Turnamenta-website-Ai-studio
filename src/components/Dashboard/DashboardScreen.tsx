...
export const DashboardScreen: React.FC<DashboardScreenProps> = ({ onNavigate }) => {
  ...
  // 8 Specific Stat Cards required by Master Spec
  const statCards = [
    {
      id: 'total-users',
      label: 'Total Users',
    ...
    },
    {
      ...
      icon: Trophy,
      color: 'from-[#B6FF3C]/20 to-[#B6FF3C]/5 border-[#B6FF3C]/40 text-[#B6FF3C]',
    ...
    },
    {
      ...
      icon: XCircle,
      color: 'from-slate-500/20 to-slate-600/10 border-slate-600/40 text-slate-300',
      action: () => onNavigate('withdrawals'),
